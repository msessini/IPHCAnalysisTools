...
void NtupleReader::Init(TTree *tree, TString Sys)
{
  ...
  fChain->SetBranchAddress("trailingjetPt", &_trailingjetPt, &b_trailingjetPt);
  ...
  fChain->SetBranchAddress("ditauMass", &_ditauMass, &b_ditauMass);
  ...
  fChain->SetBranchAddress("trueMCId", &_trueId, &b_trueId);
  ...
  fChain->SetBranchAddress("isH", &_isH, &b_isH);
